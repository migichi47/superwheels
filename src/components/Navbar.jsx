    ...
    <div className="sticky flex items-center md:top-15 top-12 border-b-3 border-primary/50 z-100 bg-white py-3">
      ...
      <div className="flex w-fit mx-auto gap-10 items-center">
        <div className="h-full flex relative group">
          <div className="flex py-2 px-4 rounded-md gap-10 bg-linear-to-b hover:from-primary hover:to-primary/0 transition-colors cursor-pointer from-gray-300 to-gray-100 items-center">
            <span className="text-[12px] sm:text-sm">All Categories</span>
            <FiFilter />
          </div>
          <ul className="absolute text-gray-700 top-10 hidden group-hover:block [&>li]:py-1 [&>li]:hover:bg-primary bg-white shadow-lg h-fit w-46 [&>li]:pl-4 [&>li]:border-gray-300 [&>li]:cursor-pointer [&>li]:pr-2 [&>li]:border-b  opacity-0 -translate-y-80 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-1000">
            <li>Side Mirrors</li>
            <li>Doors</li>
            <li>Bonnets</li>
            <li>Wind Breakers</li>
